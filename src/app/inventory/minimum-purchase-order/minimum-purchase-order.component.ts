...
@Component({
  selector: 'app-minimum-purchase-order',
  templateUrl: './minimum-purchase-order.component.html',
  styleUrls: ['./minimum-purchase-order.component.css']
})
export class MinimumPurchaseOrderComponent implements OnInit {
